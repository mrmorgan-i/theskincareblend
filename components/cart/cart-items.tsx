        ...
        <motion.div className="flex flex-col items-center">
            {cart.length === 0 && (
                <div className="flex-col w-full flex items-center justify-center">
                    ...
                    <h2 className="text-2xl text-center text-muted-foreground">Your cart is empty</h2>
            ...
            <motion.div className="flex items-center justify-center relative my-4 overflow-hidden">
                <span className="text-md font-bold">Total: GH₵</span>
                <AnimatePresence mode="popLayout">
                    {priceInLetters.map((letter, i) => (
                        ...
                        <motion.span
                            ...
                            className="text-md inline-block font-bold"
                        >
                            {letter.letter}
                        </motion.span>
                        </motion.div>
